...
![](https://img-blog.csdnimg.cn/direct/a29c0b6f65f84487a3b10995b2f45632.png)
...
![](https://img-blog.csdnimg.cn/direct/25c170da1baf4fd3998839ad8c7ff0f6.png)

#### 2、矩阵形式

![](https://img-blog.csdnimg.cn/direct/a99a726c53e3420a9e259584cfaa159d.png)
...
3. 数字图像的基本类型：
   ...
   3. 索引图像
      ...
      既包括存放图像数据的二维矩阵，还包括一个颜色索引矩阵（MAP），因此称为索引图像/映射图像。

   4. 彩色图像

      指每个像素的信息由RGB三原色构成的图像，其中R、G、B是由不同的灰度级来描述的。

#### [4](https://blog.csdn.net/Liu_Xin233/article/details/135232531)、数字图像处理的特点
...
#### [5](https://blog.csdn.net/Liu_Xin233/article/details/135232531)、数字图像处理的研究内容
...
#### [7](https://blog.csdn.net/Liu_Xin233/article/details/135232531)、部分应用领域★
...
### [二、空间转换的常见种类](https://blog.csdn.net/Liu_Xin233/article/details/135232531)
...
图像中的噪音是指在图像生成、保存和传递过程中由外部干扰在图像中加入的**冗余信息**。例如，电视画面上常见的雪花点就是一种典型的噪音。
...
![](assets/28f1afcb2ab7426d9acb3a01f08a5689.png)

例如，Med{2,0,5,9,0,0,18,1,29}=2 。{2,0,5,9,0,0,18,1,29}排序后变成{0,0,0,1,**2**,5,9,18,29}，容易看出，中值是第5号元素2。

> 中值滤波具有不损失有效信息的优点。

### [三、](https://blog.csdn.net/Liu_Xin233/article/details/135232531)OpenCV中的平滑处理
...
### [四、图像锐化处理方法](https://blog.csdn.net/Liu_Xin233/article/details/135232531)★

> 概念，简述题

图像锐化处理的**主要目的**是突出图像中的细节或者增强被模糊化了的**细节**，一般情况下图像的锐化被用于景物**边界**的检测与提取，把景物的结构**轮廓**清晰地表现出来。

使用锐化方法处理后的图像，**轮廓线条**将明显得到增强。轮廓线以外的部分将变得较暗，而轮廓线部分将变得比较明亮。

#### [五、方向模板](https://blog.csdn.net/Liu_Xin233/article/details/135232531)★

有时需要在图像中抽出**某一特定方向**的轮廓线，这时可以使用方向模板来达到这一目的。根据所需的方向，可从下列8种模板中选取合适的模板。

![](assets/daf68e94ef054d269cfd3c661c9f758d.png)

### [六、形态学操作](https://blog.csdn.net/Liu_Xin233/article/details/135232531)★
...
### [一、灰度直方图](https://blog.csdn.net/Liu_Xin233/article/details/135232531)
...
### [一、前言](https://blog.csdn.net/Liu_Xin233/article/details/135232531)
...
#### [1](https://blog.csdn.net/Liu_Xin233/article/details/135232531)、创建窗口
...
#### [2](https://blog.csdn.net/Liu_Xin233/article/details/135232531)、显示图像
...
#### [3](https://blog.csdn.net/Liu_Xin233/article/details/135232531)、响应键盘事件
...
#### [4](https://blog.csdn.net/Liu_Xin233/article/details/135232531)、选取矩形子集
